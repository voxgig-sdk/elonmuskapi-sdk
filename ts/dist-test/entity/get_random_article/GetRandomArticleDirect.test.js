...
(0, node_test_1.describe)('GetRandomArticleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ElonmuskapiSDK({
    ...
    (0, node_test_1.test)('direct-load-get_random_article', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_random_article', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ELONMUSKAPI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ElonmuskapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ELONMUSKAPI_TEST_GET_RANDOM_ARTICLE_ENTID'];
    ...
    const client = new __1.ElonmuskapiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetRandomArticleDirect.test.js.map