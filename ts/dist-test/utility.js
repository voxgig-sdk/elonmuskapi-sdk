...
function envOverride(m) {
    if ('TRUE' === process.env.ELONMUSKAPI_TEST_LIVE ||
        'TRUE' === process.env.ELONMUSKAPI_TEST_OVERRIDE) {
    ...
    m.ELONMUSKAPI_TEST_EXPLAIN = process.env.ELONMUSKAPI_TEST_EXPLAIN || m.ELONMUSKAPI_TEST_EXPLAIN;
    return m;
}
