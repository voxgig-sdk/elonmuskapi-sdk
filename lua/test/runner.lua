...
function runner.env_override(m)
  local live = runner.getenv("ELONMUSKAPI_TEST_LIVE")
  local override = runner.getenv("ELONMUSKAPI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ELONMUSKAPI_TEST_EXPLAIN")
