...
describe("GetRandomArticleDirect", function()
  it("should direct-load-get_random_article", function()
    local setup = get_random_article_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_random_article", setup.live and "live" or "unit")
