...
local GetRandomArticleEntity = {}
GetRandomArticleEntity.__index = GetRandomArticleEntity


function GetRandomArticleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomArticleEntity)
  self._name = "get_random_article"
  self._client = client
...
function GetRandomArticleEntity:get_name()
  return self._name
end


function GetRandomArticleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomArticleEntity.new(self._client, opts)
end
...
function GetRandomArticleEntity:mark_deleted()
  self._deleted = true
end


function GetRandomArticleEntity:deleted()
  return true == self._deleted
end


function GetRandomArticleEntity:data_set(args)
  if args ~= nil then
...
function GetRandomArticleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomArticleEntity:match_set(args)
  if args ~= nil then
...
function GetRandomArticleEntity:match_get()
...
function GetRandomArticleEntity:stream(action, args, callopts)
...
function GetRandomArticleEntity:_run_op(ctx, post_done)
  local utility = self._utility
