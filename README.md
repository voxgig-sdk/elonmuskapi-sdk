...
Learn more about ElonMuskAPI at [elonmu.sh](https://elonmu.sh/).

This is an unofficial SDK for the ElonMusk public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — GetRandomArticle — that you
...
const getrandomarticle = await client.GetRandomArticle().load()
// getrandomarticle is the GetRandomArticle entity, populated with mock data
...
$client = ElonmuskapiSDK::test([
    "entity" => ["getrandomarticle" => ["test01" => []]],
]);
$getrandomarticle = $client->GetRandomArticle()->load();
```
...
| Python | `voxgig-sdk-elonmuskapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/elonmuskapi-sdk/tags) |
| PHP | `voxgig-sdk/elonmuskapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/elonmuskapi-sdk/tags) |
| Golang | `github.com/voxgig-sdk/elonmuskapi-sdk/go` | `go get github.com/voxgig-sdk/elonmuskapi-sdk/go@latest` |
| Ruby | `voxgig-sdk-elonmuskapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/elonmuskapi-sdk/tags) |
| Lua | `voxgig-sdk-elonmuskapi-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/elonmuskapi-sdk/tags) |
...
| --- | --- | --- |
| **GetRandomArticle** | The GetRandomArticle entity (load). | `/` |
...
// Load a specific getrandomarticle (returns the ENTITY; call data_get() for the record; throws on error)
$getrandomarticle = $client->GetRandomArticle()->load();
...
# Load a specific getrandomarticle (returns the ENTITY; call data_get for the record)
getrandomarticle = client.GetRandomArticle.load()
...
- Upstream API: [https://elonmu.sh/](https://elonmu.sh/)
