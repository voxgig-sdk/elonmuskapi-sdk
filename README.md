...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/elonmuskapi` | `npm install @voxgig-sdk/elonmuskapi` |
| Python | `voxgig-sdk-elonmuskapi` | `pip install voxgig-sdk-elonmuskapi` |
| PHP | `voxgig-sdk/elonmuskapi` | `composer require voxgig-sdk/elonmuskapi` |
| Golang | `github.com/voxgig-sdk/elonmuskapi-sdk/go` | `go get github.com/voxgig-sdk/elonmuskapi-sdk/go` |
| Ruby | `voxgig-sdk-elonmuskapi` | `gem install voxgig-sdk-elonmuskapi` |
| Lua | `voxgig-sdk-elonmuskapi` | `luarocks install voxgig-sdk-elonmuskapi` |
