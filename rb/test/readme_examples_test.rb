...
#      offline in seeded test mode (ElonmuskapiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Elonmuskapi_sdk.rb")
  SDK_CLASS = "ElonmuskapiSDK"
