...
module ElonmuskapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("ELONMUSKAPI_TEST_LIVE")
    override = getenv("ELONMUSKAPI_TEST_OVERRIDE")
    ...
    explain = getenv("ELONMUSKAPI_TEST_EXPLAIN")
    m["ELONMUSKAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ElonmuskapiTestRunner
Helpers = ElonmuskapiHelpers
Vs = VoxgigStruct
