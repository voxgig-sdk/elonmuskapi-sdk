...
type GetRandomArticleEntity struct {
	name    string
	client  *core.ElonmuskapiSDK
...
func NewGetRandomArticleEntity(client *core.ElonmuskapiSDK, entopts map[string]any) *GetRandomArticleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetRandomArticleEntity) GetName() string { return e.name }
...
func (e *GetRandomArticleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRandomArticleEntity) Deleted() bool {
	return e.deleted
}


func (e *GetRandomArticleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetRandomArticleEntity(e.client, opts)
}

func (e *GetRandomArticleEntity) Data(args ...any) any {
...
func (e *GetRandomArticleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetRandomArticle; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRandomArticleEntity) DataTyped(data ...GetRandomArticle) GetRandomArticle {
	if len(data) > 0 {
		return typedFrom[GetRandomArticle](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRandomArticle](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRandomArticle (all fields
// optional at the wire level).
func (e *GetRandomArticleEntity) MatchTyped(match ...GetRandomArticle) GetRandomArticle {
	if len(match) > 0 {
		return typedFrom[GetRandomArticle](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRandomArticle](e.Match())
}
...
func (e *GetRandomArticleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetRandomArticleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetRandomArticleLoadMatch and returns an GetRandomArticle. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetRandomArticleEntity) LoadTyped(reqmatch GetRandomArticleLoadMatch, ctrl map[string]any) (GetRandomArticle, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetRandomArticle{}, err
	}
	return typedFrom[GetRandomArticle](res), nil
}



func (e *GetRandomArticleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetRandomArticleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetRandomArticleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetRandomArticleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetRandomArticleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
