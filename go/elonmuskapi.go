...
// instead of `sdk.NewElonmuskapiSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ElonmuskapiSDK  { return NewElonmuskapiSDK(nil) }
func Test() *ElonmuskapiSDK { return TestSDK(nil, nil) }
