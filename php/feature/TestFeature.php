...
// Elonmuskapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ElonmuskapiTestFeature extends ElonmuskapiBaseFeature
{
    ...
    public function init(ElonmuskapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ElonmuskapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ElonmuskapiParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ElonmuskapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ElonmuskapiContext $ctx, $op, $args): array
    {
