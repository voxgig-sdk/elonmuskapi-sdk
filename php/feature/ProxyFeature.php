...
class ElonmuskapiProxyFeature extends ElonmuskapiBaseFeature
{
    ...
    public function init(ElonmuskapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ElonmuskapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
