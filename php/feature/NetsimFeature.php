...
// Elonmuskapi SDK netsim feature
...
class ElonmuskapiNetsimFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _simulate(ElonmuskapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ElonmuskapiContext $ctx, array $applied): void
    {
        $client = $this->client;
