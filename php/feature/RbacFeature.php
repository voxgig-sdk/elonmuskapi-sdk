...
class ElonmuskapiRbacFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _required(ElonmuskapiContext $ctx): ?string
    {
    ...
    private function _reject(ElonmuskapiContext $ctx, string $required): void
    {
    ...
    private function _track(ElonmuskapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
