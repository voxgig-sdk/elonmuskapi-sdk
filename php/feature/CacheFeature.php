...
class ElonmuskapiCacheFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _through(ElonmuskapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
