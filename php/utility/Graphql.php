...
// Elonmuskapi SDK utility: graphql
//
...
class ElonmuskapiGraphql
{
    ...
    // equivalent.
    public static function body(ElonmuskapiContext $ctx): mixed
    {
    ...
    public static function errors(ElonmuskapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
