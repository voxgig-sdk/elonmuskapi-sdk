...
// Elonmuskapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ElonmuskapiSDK::test)
...
{
    private const SDK_CLASS = 'ElonmuskapiSDK';
    ...
    private const SDK_BASE = 'elonmuskapi_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../elonmuskapi_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
