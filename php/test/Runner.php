...
class ElonmuskapiTestRunner
{
    ...
    {
        $live = self::getenv('ELONMUSKAPI_TEST_LIVE');
        $override = self::getenv('ELONMUSKAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ELONMUSKAPI_TEST_EXPLAIN');
...
class_alias('ElonmuskapiTestRunner', 'Runner');
class_alias('ElonmuskapiHelpers', 'Helpers');
