// Command Elonmuskapi-mcp is an MCP server exposing the Elonmuskapi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Elonmuskapi_list  — list records of an entity
//	Elonmuskapi_load  — load a single record of an entity
//
