...
Results: Successful response with a random news article.
...
| --- | --- | --- | --- |
| GetRandomArticle | `load` | `GET /` | See reference |

## Connect to the API

- Production server: `https://elonmu.sh`
...
- `elonmuskapi_list`: List records for an entity. No active entity supports this operation.
- `elonmuskapi_load`: Load one record for an entity. Supported entities: `get_random_article`.
