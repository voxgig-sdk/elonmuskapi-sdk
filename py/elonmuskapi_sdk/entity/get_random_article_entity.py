...
from elonmuskapi_sdk.elonmuskapi_types import (
    GetRandomArticle,
...
class GetRandomArticleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomArticleEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomArticle:
    ...
    def match_get(self) -> GetRandomArticle:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetRandomArticle:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetRandomArticle().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
