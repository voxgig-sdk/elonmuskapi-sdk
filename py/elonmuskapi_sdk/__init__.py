...
from elonmuskapi_sdk.utility import register

# Load features
from elonmuskapi_sdk.feature.base_feature import ElonmuskapiBaseFeature
from elonmuskapi_sdk.features import _has_feature, _make_feature
...
class ElonmuskapiSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ElonmuskapiUtility()
        self._utility = utility

        from elonmuskapi_sdk.config import shared_config
    ...
    def get_utility(self):
        return ElonmuskapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ElonmuskapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetRandomArticle(self, data=None) -> "GetRandomArticleEntity":
        ...
        from elonmuskapi_sdk.entity.get_random_article_entity import GetRandomArticleEntity
        return GetRandomArticleEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ElonmuskapiSDK":
        if sdkopts is None:
            sdkopts = {}
