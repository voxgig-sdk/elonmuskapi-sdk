# Elonmuskapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ElonmuskapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ElonmuskapiSDK(...) and ElonmuskapiSDK.test(...) become
#      ElonmuskapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "elonmuskapi_sdk"
_SDK_CLASS = "ElonmuskapiSDK"
...
_ENTITIES = {
    "GetRandomArticle": "get_random_article",
}
