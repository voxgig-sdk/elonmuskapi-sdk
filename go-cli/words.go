...
func registerSDKWords(r *eng.Registry, client *sdk.ElonmuskapiSDK) {
...
func runOp(client *sdk.ElonmuskapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
