...
AQL-driven CLI and REPL for the Elonmuskapi SDK. Positional arguments are
...
./elonmuskapi-cli list get_random_article
./elonmuskapi-cli load 1 get_random_article
./elonmuskapi-cli load '{id:1}' get_random_article
