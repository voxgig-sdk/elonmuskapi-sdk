// Command Elonmuskapi-cli is a CLI + REPL for the Elonmuskapi SDK,
...
const prompt = "elonmuskapi"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "get_random_article"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ELONMUSKAPI_APIKEY (api key), ELONMUSKAPI_BASE (base url override)")
