...
|---|---|---|
| `ts/` | @voxgig-sdk/elonmuskapi-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/elonmuskapi-sdk \
      --repository voxgig-sdk/elonmuskapi-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/elonmuskapi-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/elonmuskapi-sdk --id=<id>` removes one.
