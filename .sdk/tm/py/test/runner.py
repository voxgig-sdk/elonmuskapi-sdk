...
class ElonmuskapiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ElonmuskapiTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ElonmuskapiTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ElonmuskapiTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
