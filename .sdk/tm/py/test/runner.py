...
class ElonmuskapiTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ElonmuskapiTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ElonmuskapiTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ElonmuskapiTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
