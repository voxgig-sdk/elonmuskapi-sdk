...
// Elonmuskapi SDK streaming feature
...
class ElonmuskapiStreamingFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _iterate(ElonmuskapiResult $result): \Generator
    {
    ...
    private function _streamable(ElonmuskapiContext $ctx): bool
    {
