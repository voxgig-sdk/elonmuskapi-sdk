...
// Elonmuskapi SDK clienttrack feature
...
class ElonmuskapiClienttrackFeature extends ElonmuskapiBaseFeature
{
    ...
    public function PostConstruct(ElonmuskapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Elonmuskapi-SDK';
