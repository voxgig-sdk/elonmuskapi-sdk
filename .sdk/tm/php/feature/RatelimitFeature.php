...
// Elonmuskapi SDK ratelimit feature
...
class ElonmuskapiRatelimitFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _acquire(ElonmuskapiContext $ctx): void
    {
    ...
    private function _track(ElonmuskapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
