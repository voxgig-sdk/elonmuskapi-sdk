...
// Elonmuskapi SDK idempotency feature
...
class ElonmuskapiIdempotencyFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _mutating(ElonmuskapiContext $ctx): bool
    {
