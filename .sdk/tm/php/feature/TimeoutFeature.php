...
// Elonmuskapi SDK timeout feature
...
class ElonmuskapiTimeoutFeature extends ElonmuskapiBaseFeature
{
    ...
    private function _with_timeout(ElonmuskapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ElonmuskapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
