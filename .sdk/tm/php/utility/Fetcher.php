...
class ElonmuskapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ElonmuskapiSDK/1.0)';
    ...
    public static function call(ElonmuskapiContext $ctx, string $fullurl, array $fetchdef): array
    {
